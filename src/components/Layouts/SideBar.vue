<template lang="">
    <aside id="separator-sidebar" class="border border-gray-100 z-40 w-64  rounded-2xl transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <UserCard />
        <div class="h-full px-3 py-4 overflow-y-auto bg-white">
           <ul class="space-y-2 font-medium">
              ...
              <li>
                 <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-gray-700">
