...
<template>
    <section :class="Auth.isLoading ? ' animate-pulse pointer-events-none ' : ''" class="bg-white py-40 md:max-w-md s ">
        <div class="flex  items-center justify-center px-2 py-2 mx-auto md:h-auto lg:py-0">
